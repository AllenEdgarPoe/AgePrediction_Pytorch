...
if __name__ == "__main__":
    ...
    # parser.add_argument('--model_save_path', type=str, default="model_load/model1_LAP/Clss/vgg16_epoch_")
    parser.add_argument('--model_save_path', type=str, default="model_load/model2_IMDB_LAP/Clss/vgg16_epoch_")
    ...
    parser.add_argument('--logger_path', default='./logger/model2/Clss/vgg16/')
    ...
    parser.add_argument('--lr_decay_epochs', default=[60])
